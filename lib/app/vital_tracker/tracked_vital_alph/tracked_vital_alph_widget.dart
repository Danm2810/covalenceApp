...
import 'tracked_vital_alph_model.dart';
export 'tracked_vital_alph_model.dart';

class TrackedVitalAlphWidget extends StatefulWidget {
  const TrackedVitalAlphWidget({
    super.key,
  ...
  @override
  State<TrackedVitalAlphWidget> createState() => _TrackedVitalAlphWidgetState();
}

class _TrackedVitalAlphWidgetState extends State<TrackedVitalAlphWidget> {
  late TrackedVitalAlphModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrackedVitalAlphModel());
  }
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'Date: ${dateTimeFormat("MMMEd", widget.trackedVital?.dateRecorded)}',
