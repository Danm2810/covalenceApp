...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    covalenceAppAuthUserSubject.add(
      CovalenceAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CovalenceAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CovalenceAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CovalenceAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    covalenceAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
CovalenceAppAuthUser? currentUser;
