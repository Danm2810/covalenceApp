            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  child: wrapWithModel(
                    ...
                    child: CalendarComponentWidget(
                      isWeek: _model.isWeek ? true : false,
                ...
                Align(
                  ...
                  child: ToggleIcon(
                    onPressed: () async {
                      safeSetState(() => _model.isWeek = !_model.isWeek);
                      _model.updatedDates = await actions.getDates(
                        _model.isWeek,
                      );
                      _model.displayDates =
                          _model.updatedDates!.toList().cast<DateTime>();
                      safeSetState(() {});
